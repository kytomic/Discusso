...
import static com.chatapp.discusso.constant.Constant.X_REQUESTED_WITH;
...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.addExposedHeader(ACCESS_CONTROL_ALLOW_ORIGIN);
        corsConfiguration.addExposedHeader(ACCESS_CONTROL_ALLOW_CREDENTIALS);
